...
> Visningsnamn visas i svenska `name-roll`-format för människor. Routing, agentmappar och issue-etiketter använder fortsatt stabila interna ID:n som `lisa`, `oskar`, `maja` och `axel`.
...
| Triage, scope och större kodbeslut | lisa-lösningslotsen (`lisa`) | Issue-triage, prioriteringar, ägarskap och sista ordet när kodspår krockar |
...
4. **Visningsnamn är för människor; interna ID:n är för stabilitet.** Behåll `squad:lisa`, `squad:oskar`, `squad:axel`, osv. även om rostertexten är mer göteborgsk.
