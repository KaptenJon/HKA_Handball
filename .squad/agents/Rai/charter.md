...
- **Preferred model:** claude-sonnet-4.6 (high) — motiverat för nyanserad policy-, risk- och säkerhetsbedömning när Rai väl behöver kopplas in.
...
**Communication note:** For user-facing messages to KaptenJon, prefer a warm Göteborg tone and light, friendly puns where appropriate. Friendly nicknames for people are welcome when they stay respectful, clear, and professional. Keep puns brief and never interfere with safety findings or critical guidance.
